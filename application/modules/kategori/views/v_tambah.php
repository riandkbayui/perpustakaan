<div class="container">
	<form method="post" action="<?php echo base_url('kategori/crud_tambah') ?>">
		<div class="row">
			<?php foreach ($daftar_kategori as $var): ?>
				<div class="col-md-8">
					<div class="form-group">
						<label><?php echo strtoupper(str_replace('_', ' ', $var)) ?></label>
						<input autocomplete="off" type="text" id="<?php echo $var ?>" name="<?php echo $var ?>" class="form-control">
					</div>
				</div>
				<?php if ($var == 'id_kategori'): ?>
					<div class="col-md-4">
