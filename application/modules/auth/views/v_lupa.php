  ...
  <div class="card">
    <div class="card-body login-card-body">
      ...
      <form action="<?php echo base_url('auth/checkLogin') ?>" method="post">
        ...
        <div class="form-group has-feedback">
          <div class="input-group">
              <input type="text" autocomplete="off" id="nik" name="nik" class="form-control" placeholder="Masukkan NIK">
              <div class="input-group-append">
                <span class="input-group-text form-control-feedback"><i class="fas fa-envelope"></i></span>
              </div>
          </div>
        </div>
        <p><a href="<?php echo base_url('auth/login') ?>"><i class="fas fa-arrow-left"></i> Kembali Login</a></p>
        <div><hr></div>
